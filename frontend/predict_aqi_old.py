...
def get_aqi_endpoint():
    try:
        ...
        # 1. Fetch satellite data and AOD
        ...
        pm25_pred = max(0.0, pm25_pred)  # no negatives

        # 4. Convert PM2.5 to Indian AQI
        aqi_score, aqi_category = calculate_indian_aqi(pm25_pred)
        
        print(f"✅ Prediction Complete -> AQI: {aqi_score} ({aqi_category}), PM2.5: {round(pm25_pred, 2)}")
...
if __name__ == "__main__":
    print("\n==== Satellite-Based India AQI Predictor Backend Starting ====\n")
